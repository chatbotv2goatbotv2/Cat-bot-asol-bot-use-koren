module.exports = {
  config: {
    ...
    countDown: 5,
    role: 1,
    shortDescription: "Lock your group like Disabled Message permission",
    category: "moderation",
  },
  ...
  onChat: async function ({ api, event }) {
    ...
    try {
      ...
      return api.sendMessage("❌ Filled to lock group. Maybe  already locked your group or bot isn't admin.", threadID, messageID);
    }
    ...
    setTimeout(async () => {
      try {
        ...
        api.sendMessage(`⏰ Time up! Now group has been Unlocked automatically.`, threadID);
      } catch {
